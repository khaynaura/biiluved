...
def register(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            form.save()
            messages.success(request, f"'Welcome to biiLUVed, a place where everything is luuved!")
...
def add_product_entry_ajax(request):
    ...
    conditions= strip_tags(request.POST.get("conditions"))
    brand = strip_tags(request.POST.get("brand"))
    gender = strip_tags(request.POST.get("gender"))
